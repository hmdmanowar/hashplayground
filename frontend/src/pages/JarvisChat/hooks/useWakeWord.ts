...
// the mic/speakers right now" (see JarvisChat.tsx) — only one recognition
// session can usefully run at a time, and this would otherwise fight with
// active command capture or risk picking up Jarvis's own spoken replies.
